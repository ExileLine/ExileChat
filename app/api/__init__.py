...
from app.api.secretary_api.secreatry_category_api import secretary_category_router
from app.api.secretary_api.secretary_api import secretary_router
...
admin.include_router(secretary_category_router, prefix="/secretary_category", tags=["助手分类"])
admin.include_router(secretary_router, prefix="/secretary", tags=["助手"])
